...
\vspace{1em}
\noindent \textbf{项目链接：} \url{https://github.com/greensoo/-Python-}
\vspace{1em}。
...
\subsection{数据来源与描述}
本文使用的数据集为 \texttt{insurance.csv}，
\vspace{1em}
\noindent \textbf{数据集链接：} \url{https://www.kaggle.com/datasets/mirichoi0218/insurance?resource=download}
\vspace{1em}。
这是一个在保险精算分析中广泛使用的基准数据集。该数据集包含 1338 个独立的观测样本，每个样本代表一名投保人。数据集无缺失值，数据质量良好。
